...
import docx
import pdfplumber
from tkinter import Tk, Button, filedialog, Label, Scale, OptionMenu, StringVar, messagebox, Entry, ttk
import threading
...
def convert_file():
    global file_path, extract_text, progress_bar, convert_button, voice_options
...
def main():
    ...
    # File path entry
    file_path_label = Label(form_frame, text="File Path:", font=("Arial", 12))
    ...
    upload_button = Button(form_frame, text="Upload File", command=select_file, font=("Arial", 12))
    ...
    voice_label = Label(form_frame, text="Select Voice:", font=("Arial", 12))
    ...
    # Rate selection
    rate_label = Label(form_frame, text="Select Rate:", font=("Arial", 12))
    ...
    # Volume selection
    volume_label = Label(form_frame, text="Select Volume:", font=("Arial", 12))
    ...
    # Pitch selection
    pitch_label = Label(form_frame, text="Select Pitch:", font=("Arial", 12))
    ...
    convert_button = Button(form_frame, text="Convert File", command=convert_file, font=("Arial", 12))
